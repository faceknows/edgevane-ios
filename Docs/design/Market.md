...
**始终：** 导航栏代码 + 涨跌幅 + 成交量缩写；右上角 **账户今日盈亏徽标**（Trading 组合盈亏，文案不要写成该标的盈亏）；最新价（有订阅用 Quote 的 last；未订阅用摘要/快照）；RSI/ADX/ATR 等数字徽标（按当前 1/3/5 分钟棒现场算）、分钟图、盘前盘后、偏好控制的日线 / **纳指矮图**、加入订阅按钮。交易相关时间按美东。
